    ...
    StudentBookService.prototype.getDiariesList = function (date) {
        ...
        return this._http
            ...
            if (response.data.length) {
                var sortedWeekData = _this.sortDataByWeekDay(response.data);
...
/* harmony import */ var _student_book_routing_module__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./student-book-routing.module */ "./src/app/student-book/student-book-routing.module.ts");
/* harmony import */ var _student_book_student_book_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./student-book/student-book.component */ "./src/app/student-book/student-book/student-book.component.ts");
/* harmony import */ var _services_student_book_services_student_book_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../services/student-book-services/student-book.service */ "./src/app/services/student-book-services/student-book.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    StudentBookModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            imports: [
                ...
                _student_book_routing_module__WEBPACK_IMPORTED_MODULE_7__["StudentBookRoutingModule"],
            ...
            providers: [_services_student_book_services_student_book_service__WEBPACK_IMPORTED_MODULE_9__["StudentBookService"]],
            declarations: [_student_book_student_book_component__WEBPACK_IMPORTED_MODULE_8__["StudentBookComponent"]]
        })
    ], StudentBookModule);
...
module.exports = ".student-ellipsis-table-cell, .note-ellipsis-table-cell {\n  overflow: hidden;\n  text-overflow: ellipsis;\n  white-space: nowrap; }\n\n.student-ellipsis-table-cell:hover:after, .student-ellipsis-table-cell:focus:after, .note-ellipsis-table-cell:hover:after, .note-ellipsis-table-cell:focus:after {\n  overflow: visible;\n  text-overflow: inherit;\n  background: #fff;\n  position: absolute;\n  left: auto;\n  top: auto;\n  width: auto;\n  max-width: 20rem;\n  border: 1px solid #eaebec;\n  padding: 0 0.5rem;\n  box-shadow: 0 2px 4px 0 rgba(0, 0, 0, 0.28);\n  white-space: normal;\n  word-wrap: break-word;\n  display: block;\n  color: black;\n  margin-top: -1.25rem; }\n\n.weekSchedule {\n  margin-top: 70px;\n  margin-left: 1%; }\n\n.weekSchedule .central {\n    text-align: center;\n    position: relative; }\n\n.weekSchedule .central label {\n      font-family: 'Open Sans', 'Helvetica Neue', sans-serif; }\n\n.weekSchedule .left {\n    margin-left: 0.1em; }\n\n.weekSchedule .right {\n    padding-left: 13%; }\n\n.weekSchedule .right button {\n      margin-left: 3%; }\n\n.students-table-row {\n  height: 48px; }\n\n.students-table-row td {\n    text-align: center; }\n\n.student-ellipsis-table-cell:hover, .student-ellipsis-table-cell:focus {\n  color: transparent; }\n\n.student-ellipsis-table-cell:hover:after, .student-ellipsis-table-cell:focus:after {\n    content: attr(data-homework); }\n\n.note-ellipsis-table-cell:hover, .note-ellipsis-table-cell:focus {\n  color: transparent; }\n\n.note-ellipsis-table-cell:hover:after, .note-ellipsis-table-cell:focus:after {\n    content: attr(data-note); }\n\n.lesson-number {\n  width: 10%;\n  text-align: center !important; }\n\n.lesson-name {\n  width: auto; }\n\n.lesson-description {\n  width: auto; }\n\n.lesson-mark {\n  width: 10%; }\n\n.student-print-icon {\n  font-size: 26px;\n  position: relative;\n  top: 4px;\n  left: 6%; }\n\n.student-print-icon:hover {\n    cursor: pointer; }\n\n.ordering:nth-of-type(1) {\n  order: 1; }\n\n.ordering:nth-of-type(2) {\n  order: 3; }\n\n.ordering:nth-of-type(3) {\n  order: 5; }\n\n.ordering:nth-of-type(4) {\n  order: 2; }\n\n.ordering:nth-of-type(5) {\n  order: 4; }\n\n.ordering:nth-of-type(6) {\n  order: 6; }\n\n@media print {\n  .schedule-navigation {\n    display: none; }\n  .students-table-row {\n    height: 24px; }\n    .students-table-row td {\n      text-align: unset; }\n  .tables {\n    margin-top: -80px; } }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
_fortawesome_fontawesome_svg_core__WEBPACK_IMPORTED_MODULE_2__["library"].add(_fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_3__["faPrint"]);
var StudentBookComponent = /** @class */ (function () {
    function StudentBookComponent(studentBookService, notificationToasts) {
    ...
    StudentBookComponent.prototype.ngOnInit = function () {
        ...
        this.studentBookService.getDiariesList().subscribe(function (data) {
            ...
            return _this.notificationToasts.notify('error', 'Помилка', 'Наразі немає даних про розклад');
        });
        this.cols = [
    ...
    StudentBookComponent.prototype.changeWeekSchedule = function (week, lengthOfCalls) {
        ...
        this.studentBookService.getDiariesList(changedWeek).subscribe(function (data) {
            ...
            if (lengthOfCalls >= 0) {
                ...
                _this.notificationToasts.notify('error', 'Помилка', 'Наразі немає даних про розклад');
            }
        });
    };
    StudentBookComponent.prototype.changeScheduleView = function () {
        if (this.viewType === 'list' && !this.view) {
            this.view = true;
            this.cols.push({ field: 'mark', header: 'Оцінка', class: 'lesson-mark' }, { field: 'note', header: 'Примітка' });
        }
