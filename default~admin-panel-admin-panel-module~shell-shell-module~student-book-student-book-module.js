(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~admin-panel-admin-panel-module~shell-shell-module~student-book-student-book-module"],{
...
var DataSharingService = /** @class */ (function () {
    ...
    DataSharingService.prototype.notify = function (severity, summary, detail) {
        this.showToasts.next({ severity: severity, summary: summary, detail: detail });
    };
...
//# sourceMappingURL=default~admin-panel-admin-panel-module~shell-shell-module~student-book-student-book-module.js.map